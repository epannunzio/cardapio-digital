...
export const enroladinhoMignon = {  //cada item é um objeto
  nome: 'Enroladinho de Mignon',
  preco: 'R$ 64,90',
  imagem: enroladinhoMignonImg, //dentro de um objeto a imagem não precisa estar entre chaves após importar
